...
Better underpromising than a unstable product
---
...
The "watch project" feature remain "watch project" in the source code, but have temporarily been renamed "like project" in the UI to make sense with the current context.
